...
namespace Forum.App.Controllers
{
    ...
    public class CategoryController : IController, IPaginationController
    {
        ...
        private int LastPage => this.PostTitles.Length / 1;
        private bool IsFirstsPage => this.CurrentPage == 0;
        ...
        public IView GetView(string userName)
        {
            ...
            return new CategoryView(categoryName, this.PostTitles, this.IsFirstsPage, this.IsLastPage);
        }
